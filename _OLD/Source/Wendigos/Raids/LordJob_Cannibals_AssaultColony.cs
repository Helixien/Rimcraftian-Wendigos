...
namespace Wendigos
{
	public class LordJob_Cannibals_AssaultColony : LordJob
	{
		...
		public LordJob_Cannibals_AssaultColony()
		{
		}

		public LordJob_Cannibals_AssaultColony(SpawnedPawnParams parms)
		{
		...
		public LordJob_Cannibals_AssaultColony(Faction assaulterFaction, bool canKidnap = true, bool canTimeoutOrFlee = true, bool sappers = false, bool useAvoidGridSmart = false, bool canSteal = true)
		{
		...
		public override StateGraph CreateGraph()
		{
			...
			LordToil lordToil2 = new LordToil_CannibalsAssaultColony();
			if (useAvoidGridSmart)
			{
